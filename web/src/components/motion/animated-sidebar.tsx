'use client';
// Hooklane uses sync presence: popLayout injects styles blocked by the strict CSP.
...
function MobileSidebar({
  ...
  const [wasOpen, setWasOpen] = useState(context.openMobile);
  if (wasOpen !== context.openMobile) {
