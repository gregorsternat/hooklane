...
export function TableHeader<T>({
  ...
  const activeColumnDefinition = columns[activeIndex];
  return (
    <>
      {hasColumnMenu && activeColumn && activeColumnDefinition ? (
        <ColumnHandle
          column={activeColumnDefinition}
          index={activeIndex}
          thRefs={thRefs}
      ...
      <thead>
        <tr style={{ height: rowHeight }} aria-rowindex={1}>
          {selectable ? (
            <th
              scope="col"
              aria-colindex={1}
